  ...
  <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="../user/registration"><i class="fas fa-fw fa-user"></i>Create user</a>
          <a class="dropdown-item" href="../user/edituser"><i class="fas fa-fw fa-user"></i>Edit user</a>
          <!--a class="dropdown-item" href="../task/mytasks">Assigned tasks</a-->
          <!--div class="dropdown-divider"></div-->
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="../task/mytasks">My tasks</a>
          ...
          <!--a href="#" onClick="MyWindow=window.open('../task/newTask','MyWindow','width=600,height=300'); return false;">Click Here</a-->                  
         <a class="dropdown-item" href="../task/createtask">Create new task</a>
          <a class="dropdown-item" href="../task/uploadedtasks">Uploaded tasks</a>          
          <a class="dropdown-item" href="../task/completedtasks">Completed tasks</a>
        </div>
      </li>     
	</ul>
