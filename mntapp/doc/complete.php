					...
					<div class="panel-body">
						...
						<div class='col-sm-4'>
							...
							<!--div class='col-sm-4'>
								<div class='form-group'>
									<p>
										Maintenance Date & Time: <b><?php echo $row["end_date"];?></b>
									</p>
								</div>
							</div -->
							<div class='col-sm-2'>
			    ...
			    $(components).each(function(index, comp) {
			        ...
			        if (comp.label !== "Submit") {
			            ...
			            $(descs).each(function(idx, desc) {
			                ...
			                var subVal = FormioUtils.getValue(submission,desc.key);			                
			                if(desc.info.component.type==='selectboxes'){
			                	var json = JSON.stringify(subVal);
			                	...
			                	remarkObj.currentValue =  tmpv.join();

			                }else{
			                	remarkObj.currentValue = subVal;
			                }	
			            	...
			            	remarkObj = new Object();
			            	remarkObj.description = comp.label;
			            	remarkObj.currentValue = comp.dataValue;
