$(document).ready(function () {
    ...
    function getDateFieldHTML() {
        ...
        var date  = $('<div>').addClass('li_' + field + ' form_builder_field').html(html);        	 
        return date;
    }
    ...
    function getPreview(plain_html = '') {
        ...
        el.each(function () {
            ...
            if (data_type === 'date') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label><input data-format="dd/MM/yyyy hh:mm:ss" type="date" name="' + name + '" class="form-control"' + required + '/></div>';
            }
            if (data_type === 'button') {
            ...
            if (data_type === 'radio') {
                ...
                $(this).find('.mt-radio').each(function () {
                    ...
                    option_html += '<div class="form-check"><label class="form-check-label"></label><input type="radio" class="form-check-input" name="' + name + '" value="' + value + '">' + option + '</div>';
                });
            ...
            if (data_type === 'checkbox') {
                ...
                $(this).find('.mt-checkbox').each(function () {
                    ...
                    option_html += '<div class="form-check"><label class="form-check-label"></label><input type="checkbox" class="form-check-input" name="' + name + '[]" value="' + value + '">' + option + '</div>';
                });
                html += '<div class="form-group"><label class="control-label">' + label + '</label>' + option_html + '</div>';
            }
        });
