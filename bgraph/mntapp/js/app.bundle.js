    ...
    o.fn.extend({
        navigation: function(e) {
            var a = o.extend({
                ...
                t = o(this);
            t.hasClass(a.initClass) ? myapp_config.debugState && console.log(t.get(0) + " this menu already exists") : (t.addClass(a.initClass), t.find("li").each(function() {
                0 !== o(this).find("ul").length && (o(this).find("a:first").append("<b class='collapse-sign'>" + a.closedSign + "</b>"), "#" == o(this).find("a:first").attr("href") && o(this).find("a:first").click(function() {
                    return !1
                }))
                ...
                0 !== o(this).parent().find("ul").length && (a.accordion && (o(this).parent().find("ul").is(":visible") || (parents = o(this).parent().parents("ul"), visible = t.find("ul:visible"), visible.each(function(t) {
                    var n = !0;
                    parents.each(function(e) {
                        if (parents[e] == visible[t]) return n = !1
                    }), n && o(this).parent().find("ul") != visible[t] && o(visible[t]).slideUp(a.speed + 300, a.animate, function() {
                        o(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", !1).find("b:first").html(a.closedSign), myapp_config.debugState && console.log("nav item closed")
                    })
                    ...
                    o(this).parent("li").removeClass("open").find("a:first").attr("aria-expanded", !1).find("b:first").delay(a.speed).html(a.closedSign), myapp_config.debugState && console.log("nav item closed")
                }) : o(this).parent().find("ul:first").slideDown(a.speed, a.animate, function() {
                    o(this).parent("li").addClass("open").find("a:first").attr("aria-expanded", !0).find("b:first").delay(a.speed).html(a.openedSign), myapp_config.debugState && console.log("nav item opened")
                }))
            }))
        },
        navigationDestroy: function() {
            self = o(this), self.hasClass(myapp_config.navInitalized) ? (self.find("li").removeClass("active open"), self.find("li a").off("mousedown").removeClass("active").removeAttr("aria-expanded").find(".collapse-sign").remove(), self.removeClass(myapp_config.navInitalized).find("ul").removeAttr("style"), myapp_config.debugState && console.log(self.get(0) + " destroyed")) : console.log("menu does not exist")
        }
    })
...
function(p) {
    ...
    function o(e, n) {
        ...
        function c() {
            t = p("#" + n.wrapperId).outerWidth(), o = p.map(s.children("li:not(.nav-title)"), function(e) {
                return p(e).outerWidth(!0)
            }).reduce(function(e, t) {
                return e + t
            }, 0), a = parseFloat(s.css("margin-left"))
        }
        return n = p.extend({}, p.fn[d].defaults, n), s.css("margin-left", "0px"), s.wrap('<div id="' + n.wrapperId + '" class="nav-menu-wrapper d-flex flex-grow-1 width-0 overflow-hidden"></div>'), p("#" + n.wrapperId).before('<a href="#" id="' + n.wrapperId + '-left-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-2 ml-1 p-0 fs-xxl text-primary"><i class="fal fa-angle-left"></i></a>'), p("#" + n.wrapperId).after('<a href="#" id="' + n.wrapperId + '-right-btn" class="d-flex align-items-center justify-content-center width-4 btn mt-1 mb-1 mr-1 ml-2 p-0 fs-xxl text-primary"><i class="fal fa-angle-right"></i></a>'), p.map(s.children("li:not(.nav-title)"), function(e) {
            return p(e).outerWidth(!0)
        }), p("#" + n.wrapperId + "-left-btn").click(function(e) {
            c(), a < 0 ? i = Math.min(a + t, 0) : (i = a, console.log("left end")), s.css({
                marginLeft: i
            }), e.preventDefault()
        }), p("#" + n.wrapperId + "-right-btn").click(function(e) {
            c(), -a + t < o ? i = Math.max(a - t, -(o - t)) : (i = a, console.log("right end")), s.css({
                marginLeft: i
            }), e.preventDefault()
        }), r("onInit"), {
            option: function(e, t) {
            ...
            destroy: function(e) {
                s.each(function() {
                    var e = p(this);
                    e.css("margin-left", "0px"), e.unwrap(parent), e.prev().off().remove(), e.next().off().remove(), r("onDestroy"), e.removeData("plugin_" + d)
                })
            }
        }
    }
    p.fn[d] = function(e) {
        if ("string" == typeof e) {
            ...
            return this.each(function() {
                if (!p.data(this, "plugin_" + d) || "function" != typeof p.data(this, "plugin_" + d)[n]) throw new Error("Method " + n + " does not exist on jQuery." + d);
...
var initApp = function(e) {
    return e.listFilter = function(n, e, t) {
        t ? $(t).addClass("js-list-filter") : $(n).addClass("js-list-filter"), $(e).change(function() {
        ...
        if (myapp_config.jsArray[e]) myapp_config.debugState && console.log("This script was already loaded: " + e);
            ...
            o.type = "text/javascript", o.src = e, o.onload = function() {
                n.resolve()
            }, a.appendChild(o), myapp_config.jsArray[e] = n.promise()
        }
        ...
        return 0 != t && localStorage.setItem("themeSettings", ""), myapp_config.root_.addClass(e), initApp.checkNavigationOrientation(), 0 != t && initApp.saveSettings(), e
        ...
        navigator.userAgent.match("Firefox/") ? n.setAttribute("src", e + "/" + t + ".ogg") : n.setAttribute("src", e + "/" + t + ".mp3"), n.addEventListener("load", function() {
            n.play()
        }, !0), n.pause(), n.play()
        ...
        if ($('a[data-toggle="tab"]').on("shown.bs.tab", function(e) {
            ...
            }), n && $('[href="' + n + '"]').tab("show"), void 0 !== $.fn.slimScroll && "desktop" === myapp_config.thisDevice ? ($(".custom-scroll:not(.disable-slimscroll) >:first-child").slimscroll({
                ...
                allowPageScroll: !1,
                disableFadeOut: !1
            }), myapp_config.debugState && console.log("%c✔ SlimScroll plugin active", "color: #148f32")) : (console.log("WARN! $.fn.slimScroll not loaded or user is on desktop"), myapp_config.root_.addClass("no-slimscroll")), void 0 !== initApp.listFilter && $.isFunction(initApp.listFilter) && $("[data-listfilter]").length) {
        ...
        if (void 0 !== $.fn.dropdown ? Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1 : console.log("OOPS! bs.popover is not loaded"), $(document).on("click", ".dropdown-menu", function(e) {
                e.stopPropagation()
                ...
                switch (!0) {
                    case "toggle" === t:
                        var n = $(this).attr("data-target") || myapp_config.root_,
                            ...
                            o = $(this).attr("data-focus"); - 1 !== a.indexOf("mod-bg-") && $(n).removeClass(function(e, t) {
                            return (t.match(/(^|\s)mod-bg-\S+/g) || []).join(" ")
                        }), $(n).toggleClass(a), $(this).hasClass("dropdown-item") && $(this).toggleClass("active"), null != o && setTimeout(function() {
                            $("#" + o).focus()
                        }, 200), "undefined" == typeof classHolder && null == classHolder || (initApp.checkNavigationOrientation(), initApp.saveSettings());
                        break;
                    case "toggle-swap" === t:
                        n = $(this).attr("data-target"), a = $(this).attr("data-class");
                    ...
                    case "panel-collapse" === t:
                        (s = $(this).closest(".panel")).children(".panel-container").collapse("toggle").on("show.bs.collapse", function() {
                            s.removeClass("panel-collapsed"), myapp_config.debugState && console.log("panel id:" + s.attr("id") + " | action: uncollapsed")
                        }).on("hidden.bs.collapse", function() {
                            s.addClass("panel-collapsed"), myapp_config.debugState && console.log("panel id:" + s.attr("id") + " | action: collapsed")
                        });
                        break;
                    case "panel-fullscreen" === t:
                        (s = $(this).closest(".panel")).toggleClass("panel-fullscreen"), myapp_config.root_.toggleClass("panel-fullscreen"), myapp_config.debugState && console.log("panel id:" + s.attr("id") + " | action: fullscreen");
                        break;
                    case "panel-close" === t:
                        function i() {
                            s.fadeOut(500, function() {
                                $(this).remove(), myapp_config.debugState && console.log("panel id:" + s.attr("id") + " | action: removed")
                            })
                        }
                        ...
                        break;
                    case "theme-update" === t:
                        if ($(myapp_config.mythemeAnchor).length) $(myapp_config.mythemeAnchor).attr("href", $(this).attr("data-theme"));
                        else {
                            var l = $("<link>", {
                    ...
                    case "app-fullscreen" === t:
                        ...
                        break;
                    case "playsound" === t:
                        var d = $(this).attr("data-soundpath") || "media/sound/",
                            f = $(this).attr("data-soundfile");
                        initApp.playSound(d, f)
                }
                $(this).tooltip("hide"), myapp_config.debugState && console.log("data-action clicked: " + t), e.stopPropagation(), e.preventDefault()
...
})), $(window).scroll($.throttle(myapp_config.throttleDelay, function(e) {})), $(window).on("scroll", initApp.windowScrollEvents), jQuery(document).ready(function() {
